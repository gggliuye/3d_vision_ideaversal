        ...
        if(self.__modelLoaded == False):
            ...
            try:
                ...
                for index, (label, score), in enumerate(zip(predicted_numbers, scores)):
                    ...
                    each_object_details["position"] = detection_details
            ...
            try:
                ...
                while (input_video.isOpened()):
                    ...
                    if (ret == True):
                        ...
                        object_this_image = {}
                        object_this_image["frame"] = counting
                        ...
                        for index, (label, score), in enumerate(zip(predicted_numbers, scores)):
                            ...
                            caption = "{} {:.3f}".format(self.numbers_to_names[label], (score * 100))
                            draw_caption(detected_copy, detection_details, caption)
                        object_this_image["objects"] = output_objects_array
                        output_objects_video.append(object_this_image)
                        output_video.write(detected_copy)
                    else:
                        break
                input_video.release()
                ...
                with open('data.pickle', 'wb') as f:
                    pickle.dump(output_objects_video, f)
                return output_video_filepath
